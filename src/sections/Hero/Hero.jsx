...
export default function Hero() {
  ...
  return (
    <section
      id="home"
      className="relative -mt-20 min-h-[calc(100svh-5rem)] overflow-hidden bg-[#070b18] pt-20"
    >
      <motion.div
        aria-hidden="true"
        initial={{ opacity: 0 }}
      ...
      >
        ...
        <div className="absolute inset-x-0 bottom-0 h-64 bg-gradient-to-b from-transparent via-[#080d1b]/78 to-[#080d1b] sm:h-80" />
      </motion.div>

      <div className="relative z-20 mx-auto grid w-full max-w-7xl items-center gap-12 px-5 pb-16 pt-12 sm:px-8 sm:pt-14 lg:min-h-[calc(100svh-5rem)] lg:grid-cols-[1.06fr_0.94fr] lg:gap-14 lg:px-10 lg:pb-0 lg:pt-0 xl:gap-16">
        <motion.div
        ...
        <div className="flex w-full transform-gpu items-center justify-center lg:translate-y-3">
          <HeroImage />
        </div>
      </div>
    </section>
