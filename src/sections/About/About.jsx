    ...
    <section className="relative isolate -mt-28 overflow-hidden bg-transparent pb-16 pt-32">
      ...
      >
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, #070b18 0%, #091020 20rem, #0b1020 42rem, #0b1020 100%)",
          }}
        />
        ...
        <div className="absolute inset-0 opacity-[0.035] [background-image:linear-gradient(#ffffff_1px,transparent_1px),linear-gradient(to_right,#ffffff_1px,transparent_1px)] [background-size:68px_68px] [mask-image:linear-gradient(to_bottom,transparent_0%,black_28%)]" />
