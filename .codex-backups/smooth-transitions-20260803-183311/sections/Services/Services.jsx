  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
        <div className="absolute -left-40 top-16 h-96 w-96 rounded-full bg-blue-100/45 blur-[130px]" />
        <div className="absolute -right-40 bottom-0 h-96 w-96 rounded-full bg-indigo-100/50 blur-[130px]" />
      ...
      <div className="mx-auto w-full max-w-7xl px-5 sm:px-8 lg:px-10">
        ...
        >
          ...
          <div className="relative min-h-[430px] overflow-hidden rounded-[2.2rem] bg-slate-950 p-6 text-white shadow-[0_28px_75px_rgba(15,23,42,0.22)] sm:h-[470px] sm:p-8 lg:h-[460px]">
            ...
            {services.map((service, index) => {
              ...
              return (
                <motion.button
                  ...
                  className={`group relative isolate min-h-[205px] cursor-pointer overflow-hidden rounded-[1.8rem] border p-5 text-left outline-none transition-[border-color,box-shadow] duration-200 focus-visible:ring-4 focus-visible:ring-indigo-200 sm:p-6 ${
                    isActive
                      ? "border-indigo-400 text-indigo-900 shadow-[0_22px_52px_rgba(79,70,229,0.18)] ring-4 ring-indigo-100/80"
                      : "border-slate-100 bg-white/90 text-slate-800 shadow-[0_12px_32px_rgba(30,64,175,0.07)] hover:border-indigo-100 hover:shadow-[0_18px_42px_rgba(79,70,229,0.11)]"
                  }`}
                >
                  {isActive && (
                    <motion.span
                      layoutId="active-service-background"
                      className="absolute inset-0 -z-10 rounded-[1.8rem] bg-gradient-to-br from-indigo-50 via-white to-cyan-50"
                      transition={{ duration: 0.24, ease: [0.22, 1, 0.36, 1] }}
                    />
                  )}

                  <div
                    className={`pointer-events-none absolute -right-14 -top-14 h-40 w-40 rounded-full ${service.glow} opacity-0 blur-[55px] transition-opacity duration-300 group-hover:opacity-70 ${
                      isActive ? "opacity-60" : ""
                    }`}
                  />
                  ...
                  <div className="relative flex h-full min-h-[163px] flex-col">
                    <div className="flex items-start justify-between gap-4">
                      <span
                        className={`flex h-11 w-11 items-center justify-center rounded-[0.9rem] border border-white ${service.iconStyle} shadow-[0_8px_20px_rgba(15,23,42,0.07)] transition-transform duration-200 group-hover:scale-105`}
                      >
                        <Icon size={21} />
                      </span>
                      ...
                      <span
                        className={`rounded-full px-2.5 py-1 text-[9px] font-black uppercase tracking-[0.14em] ${
                          isActive
                            ...
                            : "border border-slate-100 bg-white/80 text-slate-400"
                        }`}
                      >
                        {isActive
                          ? "Active"
                    ...
                    <div className="mt-4 flex items-center justify-between gap-3">
                      <span
                        className={`block h-1.5 rounded-full bg-gradient-to-r ${service.gradient} transition-all duration-200 ${
